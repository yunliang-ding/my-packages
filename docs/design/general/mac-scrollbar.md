...
> 参考 [MinJieLiu] (https://github.com/MinJieLiu/mac-scrollbar)

```jsx | react
import { MacScrollbar } from '@yl-d/design';

export default () => {
  return (
    <>
      <MacScrollbar style={{ height: 300 }}>
        ...
        <p>
          You can use React as a script tag from a CDN, or as a react package on
          npm.
        </p>
