...
import type { ScrollPosition, ScrollbarProps, ActionPosition, BoxSize } from './type';
import { computeRatio, getGapSize, handleExtractSize, updateScrollElementStyle } from './util';
